...
import {
  Alert, Grid, InputLabel, Typography, Theme,
} from "@mui/material";
...
export function CreateUserForm(): React.ReactElement {
  ...
  const [errors, setErrors] = useState<
    Omit<CreateUserFormModel, "color"> & { color: string }
  >({
    username: "",
    email: "",
    password: "",
  ...
  return (
    <>
        ...
        >
          ...
          <Grid item>
            <Typography textAlign="center">
              Success! Your account has been created and an activation link was
              sent, please check your email to activate your account.
            </Typography>
          </Grid>
          <Grid item>
      ...
      {!isLoading
        && !emailSent
        && (serverError === "Email taken" || !serverError) && (
