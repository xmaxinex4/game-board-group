...
export function PrivacyPolicy(): React.ReactElement {
  ...
  return (
    <TabContentContainer title="Privacy Policy" titleTypographyVariant="h4">
      <Grid container direction="column" spacing={6}>

        <Grid container item direction="column" spacing={2}>
          <Grid item>
            <Typography variant="body2">Last updated: December 06, 2021</Typography>
          </Grid>
          <Grid item>
        ...
        <Grid container item direction="column" spacing={2}>
          ...
          <Grid item>
            <Typography variant="body2">
              <Grid container direction="column" spacing={1} sx={{ paddingLeft: "16px", paddingRight: "16px" }}>
                <Grid item>
                  Email address
                </Grid>
                <Grid item>
          ...
          <Grid item>
            <Typography variant="body2">The Company allows You to create an account and log in to use the Service through the following Third-party Social Media Services:</Typography>
          </Grid>
          <Grid item>
            <Typography variant="body2">
              <Grid container direction="column" spacing={1} sx={{ paddingLeft: "16px", paddingRight: "16px" }}>
          ...
          <Grid item>
            <Typography variant="body2">If You decide to register through or otherwise grant us access to a Third-Party Social Media Service, We may collect Personal data that is already associated with Your Third-Party Social Media Service&apos;s account, such as Your name, Your email address, Your activities or Your contact list associated with that account.</Typography>
          </Grid>
          <Grid item>
            <Typography variant="body2">You may also have the option of sharing additional information with the Company through Your Third-Party Social Media Service&apos;s account. If You choose to provide such information and Personal Data, during registration or otherwise, You are giving the Company permission to use, share, and store it in a manner consistent with this Privacy Policy.</Typography>
          </Grid>
          <Grid item>
            <Typography variant="h6">Tracking Technologies and Cookies</Typography>
          </Grid>
          <Grid item>
            <Typography variant="body2">We use Cookies and similar tracking technologies to track the activity on Our Service and store certain information. Tracking technologies used are beacons, tags, and scripts to collect and track information and to improve and analyze Our Service. The technologies We use may include:</Typography>
          </Grid>
          <Grid item>
            <Typography variant="body2">
              <Grid container direction="column" spacing={2} sx={{ paddingLeft: "16px", paddingRight: "16px" }}>
                ...
                <Grid item>
                  <Grid container spacing={0.5}>
                    ...
                    <Grid item>
                      <Link href="https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_" color={activeUser ? MeeplePaletteColors[activeUser.color].dark : theme.palette.primary.main}>&quot;Where can I change the settings for disabling, or deleting local shared objects?&quot;</Link>
                    </Grid>
                  </Grid>
                </Grid>
                <Grid item>
          ...
          <Grid item>
            <Typography variant="body2">
              <Grid container spacing={0.5}>
                ...
                <Grid item>
                  <Link href="https://www.privacypolicies.com/blog/privacy-policy-template/#Use_Of_Cookies_Log_Files_And_Tracking" color={activeUser ? MeeplePaletteColors[activeUser.color].dark : theme.palette.primary.main}>Cookies by PrivacyPolicies Generator</Link>
                </Grid>
              </Grid>
            </Typography>
          </Grid>
          ...
          <Grid item>
            <Typography variant="body2">For more information about the cookies we use and your choices regarding cookies, please visit our Cookies Policy or the Cookies section of our Privacy Policy.</Typography>
          </Grid>
          <Grid item>
          ...
          <Grid item>
            <Typography variant="body2">
              <Grid container direction="column" spacing={2} sx={{ paddingLeft: "16px", paddingRight: "16px" }}>
                <Grid item>Comply with a legal obligation</Grid>
                <Grid item>Protect and defend the rights or property of the Company</Grid>
                <Grid item>Prevent or investigate possible wrongdoing in connection with the Service</Grid>
                <Grid item>Protect the personal safety of Users of the Service or the public</Grid>
                <Grid item>Protect against legal liability</Grid>
              </Grid>
            </Typography>
          </Grid>
          <Grid item>
