      ...
      <Grid container direction="column" spacing={2}>
        ...
        <Grid item>
          <List>
            ...
            <ListItem>
              <Typography variant="body2">
                {`${<strong>Website</strong>} refers to GameBoardGroup, accessible from ${<Link href="https://gameboardgroup.com" color={activeUser ? MeeplePaletteColors[activeUser.color].dark : theme.palette.primary.main}>https://gameboardgroup.com</Link>}`}
              </Typography>
            </ListItem>
            <ListItem>
              <Typography variant="body2">
        ...
        <Grid item>
          <Typography variant="body2">
            {`Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies: ${<Link href="https://www.privacypolicies.com/blog/privacy-policy-template/#Use_Of_Cookies_Log_Files_And_Tracking" color={activeUser ? MeeplePaletteColors[activeUser.color].dark : theme.palette.primary.main}>Cookies by PrivacyPolicies Generator</Link>}.`}
          </Typography>
        </Grid>
        <Grid item>
        ...
        <Grid item>
          <List>
            <ListItem>By email: gameboardgroup@gmail.com</ListItem>
          </List>
        </Grid>
      </Grid>
    </TabContentContainer>
